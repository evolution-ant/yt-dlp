...
class ImdbIE(InfoExtractor):
    ...
    _VALID_URL = r'https?://(?:www|m)\.imdb\.com/video/(imdb|user)/vi(?P<id>\d+)'
...
class ImbdbVideoplayerIE(ImdbIE):
    IE_NAME = 'imdb_videoplayer'
    IE_DESC = 'ImbdbVideoplayer'

    _VALID_URL = r'https?://(?:www|m)\.imdb\.com/.+/vi(?P<id>\d+)'
    #http://www.imdb.com/title/tt3040964/videoplayer/vi1075360537?ref_=tt_ov_vi