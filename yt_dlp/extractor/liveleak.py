...
class LiveLeakIE(InfoExtractor):
    ...
    _TESTS = [{
        ...
        # Covers https://github.com/ytdl-org/yt-dlp/pull/5983
        ...
        # Covers https://github.com/ytdl-org/yt-dlp/pull/10664#issuecomment-247439521
    ...
    def _real_extract(self, url):
        ...
        for idx, info_dict in enumerate(entries):
            ...
            for a_format in info_dict['formats']:
                ...
                # https://github.com/ytdl-org/yt-dlp/pull/4768)
