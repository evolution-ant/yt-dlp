...
class EHowIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        try:
            ...
            youtube_id = self._search_regex(r'src="(?:https\:|http\:)\/\/www.youtube.com/embed/(.*)\?feature=oembed"', webpage, 'video URL')
            return self.url_result('http://www.youtube.com/watch?v=%s' % youtube_id)
