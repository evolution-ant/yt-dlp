...
mkdir .\bin\win\x64
xcopy  /s /e dist\__main__ .\bin\win\x64
ren .\bin\win\x64\__main__.exe YoutubeToMP3Process.exe
ren .\bin\win\x64\__main__.exe.manifest YoutubeToMP3Process.exe.manifest
